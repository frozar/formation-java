...
import fr.gouv.finances.dgfip.gabier.Gabier;
...
public class BanqueV0Application
{
    public static void main(String[] args) throws CompteException
    {
        ...
        System.out.println("*********************************************************");
        System.out.println("*** Ouverture d'un compte courant Paulette Blanchard  ***");
        CompteCourant ccPaulette = maBanque.creerCompteCourant(paulette, "1234");
        System.out.println("*** Dépôt d'un chèque de 100                          ***");
        ccPaulette.creerOperation("Dépôt chèque", 100.0);
        ccPaulette.afficherSyntheseOperations();
        System.out.println("*********************************************************\n");
        
        System.out.println("*********************************************************");
        System.out.println("*** Ouverture d'un compte courant Dominique Guibert   ***");
        CompteCourant ccDominique = maBanque.creerCompteCourant(dominique, "5678");
        System.out.println("*** Dépôt d'un chèque de 200                          ***");
        ccDominique.creerOperation("Dépôt espèces", 200.0);
        ccDominique.afficherSyntheseOperations();
        System.out.println("*********************************************************\n");

        System.out.println("*********************************************************");
        System.out.println("*** Débit de 50 sur le compte     Paulette Blanchard  ***");
        ccPaulette.creerOperation("Débit", -50.0);
        System.out.println("*** Débit de 300 sur le compte    Dominique Guibert   ***");
        ...
        System.out.println("*********************************************************");
        System.out.println("*** Ouverture d'un compte épargne Thibault Guillou    ***");
        System.out.println("*** montant initial=3000, taux=2%                     ***");
        CompteEpargne ceThibault = maBanque.creerCompteEpargne(thibault, "1234", 3000.0, 0.02);
        System.out.println("*** Crédit de 1000 sur le compte Thibaud Guillou      ***");
        ceThibault.creerOperation("Dépôt", 1000.0);
        try {
            System.out.println("*** Débit de 10000 sur le compte Thibaud Guillou      ***");
        ...
        System.out.println("*********************************************************");
        System.out.println("*** Ouverture d'un compte épargne André Labbe         ***");
        System.out.println("*** montant initial=10000, taux=2%                    ***");
        maBanque.creerCompteEpargne(andre, "5678", 10000.0, 0.02);
        System.out.println("*********************************************************\n");

        System.out.println("*********************************************************");
        System.out.println("*** Synthèse banque                                   ***");
        maBanque.afficherSyntheseComptes();
        System.out.println("*********************************************************\n");

        
        System.out.println("*********************************************************");
        System.out.println("*** Création CB Paulette                              ***");
